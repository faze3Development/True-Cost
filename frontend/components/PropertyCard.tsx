      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            onClick={onBookmark}
            className="text-on-surface-variant transition-colors hover:text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
          >
