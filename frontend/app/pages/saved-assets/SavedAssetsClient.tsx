...
import { fetchPropertyUnits, fetchUnitHistory } from "@/lib/api";
    ...
    <div className="min-h-screen bg-surface text-on-surface">
      <div className="flex min-h-screen">
        ...
        <div className="ml-64 flex min-h-screen flex-1 flex-col">
          {/* Top Command Bar */}
          <header className="sticky top-0 z-30 flex items-center justify-between bg-surface/85 px-10 py-4 backdrop-blur-2xl">
            ...
            <nav className="hidden items-center gap-7 lg:flex">
              <a className="text-sm font-semibold text-on-surface-variant transition-colors hover:text-on-surface" href="#">
                Dashboard
              </a>
              <a className="text-sm font-semibold text-on-surface-variant transition-colors hover:text-on-surface" href="#">
                Market Overviews
            ...
            <div className="flex items-center gap-3 pl-6">
              <button
                className="rounded-full p-2 text-on-surface-variant transition-all hover:bg-surface-container active:scale-95"
                type="button"
              ...
              <div className="h-9 w-9 overflow-hidden rounded-full bg-surface-container-high">
                <img
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAi_AGKZjUQ0df5aU-evW0LKQh-eOpnQ8pKlwo0ym_xK-5MIvfKX4VjK0mELTHnuciN79WF38UqD6mOB4VojQehD_ZelQu6b2N1a7BM39QY60QaBfnNHi7U98FBthf4wc5nKEHp4F1ZwzbXb9Sez7_9GqumeUzh0Ou45i2sLx4TOtUttuKlscZ08BOoEnhwYkDUE378o7TpVp1xjVOGEchpUe5Rt_EJTMqWNY0g5XhaQxBAxqkFUvgQwa5JXbAJ3L25_Mgo1USY6nyn"
                />
              </div>
            </div>
          </header>
