...
const headerTabs: HeaderTab[] = [
  ...
  { label: "Saved Reports", href: "/analytics", active: true },
  { label: "Data Exports", href: "#" },
];
...
const SAVED_REPORTS: SavedReportCardProps[] = [
  {
    ...
    imageAlt:
      "Modern luxury apartment building with glass facade and architectural lighting at twilight",
  ...
  },
  {
    ...
    imageAlt:
      "Sleek urban high-rise development in a dense metropolitan area with morning sun reflection",
  ...
  },
  {
    ...
    imageAlt:
      "Expansive view of luxury residential suites with floor to ceiling windows overlooking a river city skyline",
  ...
  },
  {
    ...
    imageAlt:
      "Converted historical warehouse into residential lofts featuring red brick and large industrial windows",
