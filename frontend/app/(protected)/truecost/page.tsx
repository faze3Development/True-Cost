...
export default function TrueCostPage() {
  ...
  const handleFeeToggle = useCallback((feeType: keyof CalculatorState['fees']) => {
    setState((prev) => ({
      ...prev,
      fees: {
        ...prev.fees,
  ...
  return (
    <AppLayout>
      <div className="pt-6 pb-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
