      ...
      <div className="min-h-screen p-6 md:p-12 font-body text-on-surface">
          ...
          <div className="col-span-12 lg:col-span-8 bg-surface-container-lowest rounded-xl p-8 border-t-2 border-secondary shadow-sm">
            <div className="flex flex-col sm:flex-row justify-between items-start mb-12 gap-6">
              <div>
                ...
                <h3 className="text-5xl font-black tracking-tighter text-primary">Pro Tier</h3>
              </div>
        ...
        <section className="mt-20">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 gap-4">
            ...
            <button className="text-xs font-bold uppercase tracking-widest text-on-surface-variant hover:text-primary flex items-center gap-2 transition-colors">
            ...
            {[
              ...
              <div key={i} className="grid grid-cols-1 sm:grid-cols-5 px-8 py-5 bg-surface-container-lowest items-center group hover:bg-surface-bright transition-colors border-b last:border-b-0 border-outline-variant/20 gap-4 sm:gap-0">
                <div className="col-span-1 sm:col-span-2">
                  <p className="font-bold text-sm text-primary">TrueCost Pro - Monthly Subscription</p>
        ...
        <section className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="bg-surface-container-lowest p-6 rounded-xl flex items-center justify-between shadow-sm">
              ...
              <button className="text-[10px] font-bold uppercase tracking-widest text-secondary hover:underline transition-all">Edit</button>
            </div>
          </div>
        ...
        <section className="mt-24 pt-12 border-t-2 border-surface-container">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-xs text-on-surface-variant mt-1">Deactivate your access to the TrueCost rental database. Data will be preserved for 30 days.</p>
            </div>
            <button className="px-6 py-3 border border-error text-error text-[10px] font-bold uppercase tracking-widest hover:bg-error hover:text-white transition-colors rounded">
              Terminate Access
            </button>
          </div>
        </section>
